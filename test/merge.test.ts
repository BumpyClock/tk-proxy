...
import { combinePayloads, type DailyContribution, type TokenContributionData } from "../src/merge.js";

function makePayload(contributions: DailyContribution[]): TokenContributionData {
  return {
    meta: {
